...
describe('RegisterComponent', () => {
  ...
  it('should display a form to register', () => {
    ...
    expect(userForm.get('password')).withContext('Your form should have a `password` field').not.toBeNull();
    expect(userForm.get('password').getError('required')).withContext('The `password` field should be required').toBe(true);
