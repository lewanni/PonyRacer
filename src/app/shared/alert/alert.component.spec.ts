...
describe('AlertComponent', () => {
  ...
  it('should compute the classes to apply', () => {
    ...
    expect(component.alertClasses).withContext('The alertClasses getter should depend on the type').toBe('alert alert-warning');

    component.type = 'danger';
    expect(component.alertClasses).withContext('The alertClasses getter should depend on the type').toBe('alert alert-danger');
  });
  ...
  it('should apply the classes on the root element', () => {
    ...
    expect(div.className).withContext('The alertClasses should be applied on the root element').toContain('alert alert-warning');
  });
