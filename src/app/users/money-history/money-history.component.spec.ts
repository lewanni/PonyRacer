...
describe('MoneyHistoryComponent', () => {
  ...
  it('should display a chart', () => {
    ...
    expect(component.moneyChart.config.type).withContext('The chart should be a line').toBe('line');
    ...
    expect(component.moneyChart.canvas).withContext('The chart context should the canvas element').toBe(canvas);
  });
});
