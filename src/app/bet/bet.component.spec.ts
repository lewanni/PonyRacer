...
describe('BetComponent', () => {
  ...
  it('should initialize the race with ngOnInit', () => {
    ...
    expect(component.raceModel).withContext('`ngOnInit` should initialize the `raceModel`').not.toBeUndefined();
  ...
  it('should display an error message if bet failed', () => {
    ...
    fixture.detectChanges();
    expect(debugElement.query(By.directive(AlertComponent))).withContext('The AlertComponent should be closable').toBeNull();
  });
